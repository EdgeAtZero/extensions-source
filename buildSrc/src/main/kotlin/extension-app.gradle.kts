...
android {
    ...
    defaultConfig {
        manifestPlaceholders += mapOf(
            "extension.name" to "Tachiyomi: ${extra["extension.name"] as String}",
            "extension.class" to extra["extension.class"] as String,
            "extension.nsfw" to if (extra["extension.nsfw"] as Boolean) "1" else "0"
        )
    }
    packaging {
        resources {
...
dependencies {
    implementation(project(":lib-manifest"))
